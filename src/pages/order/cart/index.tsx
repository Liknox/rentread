  ...
  return (
    <Layout className={cn("bg-transparent", { "!w-full": isMobile })} aria-label="cart main section">
      ...
      <section aria-label="cart books section">
        <Typography.Title level={breakpoint.xs ? 4 : 3} type="secondary" className="mb-2" aria-label="cart subtitle">
    ...
    <>
      ...
      <Row className="overflow-auto pb-5" wrap={false} gutter={[20, 0]} aria-label="cart recommendations row">
        {recommended.books
          ...
          .map(b => (
            <Col key={b.id} span={8} className="min-w-full md:min-w-[315px]" aria-label="cart recommendation book col">
              <BookCard
                data={b}
                size="small"
                className="m-0"
