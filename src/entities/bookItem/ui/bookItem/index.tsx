          ...
          {vtParam.isGrid && (
            <BookCard
              ...
              <Typography.Text type="secondary">
                {rent.status === "RENTABLE" && (
                  <span>
                    {t(TRANSLATIONS.timezone.forRent)} {Math.min(30, rent.duration)} {t(TRANSLATIONS.timezone.dayss)}
                  </span>
                )}
              </Typography.Text>
            </BookCard>
            ...
            <BookRowCard
              ...
              actions={
                <>
                  ...
                  {rent.status === "RENTABLE" && <Cart.Actions.AddBook bookId={data.id} aria-label="add to cart" />}
                  {rent.status === "RESERVABLE" && (
