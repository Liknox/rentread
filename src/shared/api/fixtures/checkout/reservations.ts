...
// FIXME: fix, in order to take later
// Only after reservation from user
...
// prettier-ignore
export const getAll = () => [YA_RES_0, VI_RES, YA_RES_1, YA_RES_2, YA_RES_3, YA_RES_4, YA_RES_5, YA_RES_6]
